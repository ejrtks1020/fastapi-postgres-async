...
from schema.user.user_schema import Token, TokenData, ChangePasswordIn, UserIn, UserOut
from common.settings import settings
from util.auth_util import AuthUtil, oauth2_scheme
...
class UserService:
    ...
    async def register_user(user_data: UserIn, session: AsyncSession):
        ...
        user_data.password = AuthUtil.get_password_hash(user_data.password)
